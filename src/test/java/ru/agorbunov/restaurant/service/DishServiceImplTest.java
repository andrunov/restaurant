...
public class DishServiceImplTest extends AbstractServiceTest {
    ...
    public void save() throws Exception {
        int[] orders = {ORDER_01_ID};
        int[] dishes = {OrderTestData.DISH_01_ID,OrderTestData.DISH_02_ID,OrderTestData.DISH_04_ID};
        service.save(DISH_CREATED,MENU_LIST_01_ID,orders,dishes);
    ...
    public void saveWithoutOrders() throws Exception {
        ...
        OrderTestData.MATCHER.assertCollectionEquals(
                ...
                service.getWithOrders(DISH_05_ID, MENU_LIST_01_ID).getOrders());
    }
    ...
    public void saveNull() throws Exception{
        ...
        service.save(null,MENU_LIST_01_ID,orders,dishes);
    }
